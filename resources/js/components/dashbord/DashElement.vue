...
<!--    <div class="dash_body">-->
        <div class="dash_item d_flex">
            ...
            <div class="dash_slug d_left">
                <div>
                    <div>{{ this.data.header }}</div>
                    <div v-if="this.data.slack"><a :href="this.base + this.data.slack" target="_blank">{{ this.data.slack }}</a></div>
            ...
            <div class="dash_edit d_flex d_left">
                ...
                <div class="dash_del" @click="del_page">
